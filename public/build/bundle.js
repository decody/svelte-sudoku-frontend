...
var app = (function () {
    ...
    /* src\layouts\DefaultLayout.svelte generated by Svelte v3.29.0 */

    const file = "src\\layouts\\DefaultLayout.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-3rqx3b");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_slots("DefaultLayout", slots, ['default']);
    ...
    axios$1.defaults.baseURL = 'http://localhost:3000';

    async function apiRequest(options) {
        const { url, method, headers = {}, params, data} = options;
        try {   
            const res = await axios$1({ url, method, headers, params, data });
            return res.data;
        } catch (err) {
            // 공통 에러 처리
            throw err;
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 16, 1, 277);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file$1, 17, 14, 314);
    			add_location(p, file$1, 17, 1, 301);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		$$invalidate(1, result = await getUser());
    	});
